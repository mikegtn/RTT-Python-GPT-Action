...
The original GPT instructions are preserved verbatim in references/gpt-instructions.md. The GPT also lists MOVEBOOK.md as knowledge, but its contents were not exportable from the editor during migration. Do not invent its contents or claim it was migrated.
