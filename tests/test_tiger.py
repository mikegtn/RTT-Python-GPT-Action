...
from rtt_app.tiger import TigerClient, TigerError, normalize_coach_list, reconcile_rtt_tiger
...
class EndpointTests(unittest.TestCase):
    def setUp(self):
        ...
        self.params = {'station': ['PAD'], 'uid': ['G01153']}
    ...
    def test_auth_dispatch_and_usage(self):
        ...
        self.client.get_service_details.assert_called_once_with('PAD', 'G01153', None)
