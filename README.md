...
Realtime Trains credentials remain server-side on the loopback Action connection.
...
[the Realtime Trains plugin](plugins/realtime-trains/README.md) for its twelve tools,
